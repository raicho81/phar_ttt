...
class TTTMain():
    def __init__(self, inner_iterations, n_iter_info_skip, game_type, train, board_size, concurrency, dbname, user, password, host, port, connection_pooling_factor):
...
class MainProcessPoolRunner:
    ...
    def pool_main_run(self):
        m = TTTMain(self.inner_iterations, self.n_iter_info_skip, self.game_type, self.train, self.board_size, self.threads_count,
